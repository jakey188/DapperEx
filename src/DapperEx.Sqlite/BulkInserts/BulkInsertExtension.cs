...
using DapperEx.Sqlite.BulkInserts.Providers;

namespace DapperEx.Sqlite.BulkInserts
{
    public static class BulkInsertExtension
    {
        ...
        public static int BulkInsert(this SqliteDbContext context, string tableName, DbDataReader dataReader)
        {
